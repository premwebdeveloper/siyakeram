...
<div class="container" style="padding-top: 170px;">
	<div class="row content wrapper ng-scope" ng-controller="pageContentController">
      	<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
	        <h2 class="light-pink">Terms & Conditions</h2>
	        <div class="divider"></div>
      	</div>
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 ng-binding" ng-bind-html="pageContent.page_content">
	...
	•	We offer seamless experience through our user friendly interface and features that can help you to manage your profile with ease.<br>
	•	We give relevant search results, unmatched filtration, 100% authentic profiles and more features.<br>
